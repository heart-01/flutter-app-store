...
import 'package:flutter_store/screens/products/components/product_image.dart';

class ProductForm extends StatefulWidget {
  final ProductModel product;
  final Function(File? file) handleOnChangeImage;
  final GlobalKey<FormState> formKey;

  const ProductForm(
    this.product, {
    required this.handleOnChangeImage,
        ...
        child: Column(
          children: [
            ...
            Row(
              children: [
                Expanded(
                  child: textInputWithoutController(
